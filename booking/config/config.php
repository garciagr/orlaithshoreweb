...
$conf['settings']['default.timezone'] = 'Europe/Dublin';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'true';         	// if users can register themselves
$conf['settings']['admin.email'] = 'admin@orlaithshore.com';         // email address of admin user
$conf['settings']['admin.email.name'] = 'O';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'http://orlaithshore.com/booking/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['home.url'] = 'http://orlaithshore.com/'; 	      					// the url to open when the logo is clicked
$conf['settings']['logout.url'] = 'http://orlaithshore.com/booking'; 	      					// the url to be directed to after logging out
...
$conf['settings']['database']['user'] = 'o569134_orlaith';        // database user with permission to the booked database
$conf['settings']['database']['password'] = '34Y7p0Yowt';
$conf['settings']['database']['hostspec'] = 'localhost';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'o569134_booking';
/**
 * Mail server configuration
 */
$conf['settings']['phpmailer']['mailer'] = 'mail';              // options are 'mail', 'smtp' or 'sendmail'
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.zoho.com';               // 'smtp.company.com'
...
$conf['settings']['phpmailer']['smtp.username'] = 'bookings@orlaithshore.com';
$conf['settings']['phpmailer']['smtp.password'] = 'R3y4rt_r0';
 ...
 */
$conf['settings']['install.password'] = '589cf1af5207e';
/**
 * Pages
 */
